    ...
    <el-row :gutter="10"
      ...
      <el-col :span="1.5">
        <el-button type="primary"
                   ...
                   size="mini"
                   @click="handleAdd"
                   v-hasPermi="['yixiu:supplier:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success"
                   ...
                   :disabled="single"
                   @click="handleUpdate"
                   v-hasPermi="['yixiu:supplier:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger"
                   ...
                   :disabled="multiple"
                   @click="handleDelete"
                   v-hasPermi="['yixiu:supplier:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning"
                   ...
                   size="mini"
                   @click="handleExport"
                   v-hasPermi="['yixiu:supplier:export']">导出</el-button>
      </el-col>
...
<script>
import { listSupplier, getSupplier, delSupplier, addSupplier, updateSupplier } from "@/api/yixiu/supplier";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport () {
      this.download('yixiu/supplier/export', {
        ...this.queryParams
