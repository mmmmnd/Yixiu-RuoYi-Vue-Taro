  ...
  <div class="app-container">
    ...
    <el-row :gutter="10"
      ...
      <el-col :span="1.5">
        <el-button type="primary"
                   ...
                   size="mini"
                   @click="handleAdd"
                   v-hasPermi="['yixiu:inventory:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success"
                   ...
                   :disabled="single"
                   @click="handleUpdate"
                   v-hasPermi="['yixiu:inventory:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger"
                   ...
                   :disabled="multiple"
                   @click="handleDelete"
                   v-hasPermi="['yixiu:inventory:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning"
                   ...
                   size="mini"
                   @click="handleExport"
                   v-hasPermi="['yixiu:inventory:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="数量"
                       align="center"
                       prop="number" />
      <el-table-column label="清单人"
                       align="center"
                       prop="createBy" />
      <el-table-column label="清单时间"
                       align="center"
                       prop="number" />
...
<script>
import { listInventory, getInventory, delInventory, addInventory, updateInventory } from "@/api/yixiu/inventory";
...
export default {
  ...
  methods: {
    ...
    handleDelete (row) {
      ...
      this.$modal.confirm('是否确认删除配件清单编号为"' + inventoryIds + '"的数据项？').then(function () {
    ...
    /** 导出按钮操作 */
    handleExport () {
      this.download('yixiu/inventory/export', {
        ...this.queryParams
