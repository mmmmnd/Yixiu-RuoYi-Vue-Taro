<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['yixiu:swiper:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['yixiu:swiper:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="swiperList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="轮播id" align="center" prop="swiperId" />
      <el-table-column label="标题" align="center" prop="title" />
      <el-table-column label="文件路径" align="center" prop="filePath" width="100">
...
<script>
import { listSwiper, getSwiper, delSwiper, addSwiper, updateSwiper } from "@/api/yixiu/swiper";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除轮播图编号为"' + swiperIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('yixiu/swiper/export', {
        ...this.queryParams
